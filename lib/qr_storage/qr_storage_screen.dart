              ...
              return GestureDetector(
                ...
                child: AnimatedSwitcher(
                  ...
                  child: deletedIndexes.contains(cardIndex)
                      ...
                      : AnimatedContainer(
                          key: ValueKey('card_${cardIndex}_${cardTitles[cardIndex].hashCode}'),
                          duration: const Duration(milliseconds: 300),
                          curve: Curves.easeInOut,
                          decoration: BoxDecoration(
                            border: Border.all(
                              color: cardPaused[cardIndex] ? Colors.orange : Colors.grey.shade300,
                              width: 2,
                            ),
          ...
          child: Row(
            children: [
              ...
              IconButton(
                ...
                onPressed: () =>
                    setState(() => selectedPage = selectedPage > 1 ? selectedPage - 1 : 1),
              ),
              ...
              IconButton(
                ...
                onPressed: () => setState(() =>
                    selectedPage = selectedPage < totalPages ? selectedPage + 1 : totalPages),
              ),
              IconButton(
                      ...
                      child: Column(
                        children: [
                          ...
                          if (isExpanded) ...[
                            ...
                            Wrap(
                              spacing: 8,
                              children: ['활성화됨', '일시중지됨'].map((status) {
                                return ChoiceChip(
                                  label: Text(status),
